    ...
    private void depotupdatebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depotupdatebuttonActionPerformed
        ...
        if (tfduold.getText().isEmpty() || tfdunew.getText().isEmpty()) {
            ...
            try {
                ...
                String updateQuery = "update milkdepot md1 join( select 1 from milkdepot where local_loc=?) md1 on md1.local_loc=md1.local_loc set md1.local_loc=? where md1.local_loc=?";
                PreparedStatement pstmt = conn.prepareStatement(updateQuery);
                pstmt.setString(1, tfduold.getText());
                pstmt.setString(2, tfdunew.getText());
                pstmt.setString(3, tfduold.getText());
